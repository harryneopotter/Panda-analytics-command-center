...
## 2026-05-09
- Generated hierarchy guidance for the repo: refreshed the root AGENTS file with an app-local pointer, added `app/AGENTS.md` for the large demo surface, and recorded the repo-wide place to look for prototype copy and metadata edits.
